  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl">
        <Link href="/compare" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow" aria-label="Go to Compare page">
        ...
        <Link href="/history" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow" aria-label="Go to History page">
        ...
        <Link href="/upload" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow" aria-label="Go to Upload page">
        ...
        <Link href="/pipelines" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow" aria-label="Go to Pipelines page">
        ...
        <Link href="/review" className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow" aria-label="Go to Review page">
